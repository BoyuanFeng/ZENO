...
impl<F: Field> AllocatedBit<F> {
    ...
    pub fn print_fqvar(&self){
        println!("fq_var:{:?}",self.variable);
    }
...
impl<F: Field> Boolean<F> {
    ...
    pub fn print_fqvar(&self){
        match self {
            Boolean::Constant(false) => println!("fq_var:Constant(false)"),
            Boolean::Constant(true) => println!("fq_var:Constant(true)"),
            Boolean::Is(v) => v.print_fqvar(),
            Boolean::Not(v) => v.print_fqvar(),
        };
    }
